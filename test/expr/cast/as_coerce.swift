...
Double(1) as Double as String // expected-error{{cannot convert value of type 'Double' to type 'String' in coercion}} // expected-warning 2 {{redundant cast to 'Double' has no effect}} {{11-21=}}
