...
func testFSEventStreamRef(stream: FSEventStreamRef) {
  ...
  _ = stream as ConstFSEventStreamRef // expected-warning {{casting expression of type 'FSEventStreamRef' (aka 'OpaquePointer') to 'ConstFSEventStreamRef' (aka 'OpaquePointer') doesn't change the type}} {{14-39=}}
