...
_ = kSecClass as CFString // expected-warning {{casting expression to 'CFString' doesn't change the type}} {{15-27=}}
_ = kSecClassGenericPassword as CFString // expected-warning {{casting expression to 'CFString' doesn't change the type}} {{30-42=}}
